  ...
  return (
    <section className="bg-gray-200 py-10 px-4">
      <div className="max-w-7xl mx-auto">
        <h1
          data-aos="fade-up"
          className="w-full text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 md:mb-8"
        >
        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div
            data-aos="fade-right"
            className="md:flex absolute -left-12 top-1/3 -translate-y-1/2 z-20"
          >
          ...
          <div className="absolute bottom-6 left-4 md:left-10 text-white max-w-md  z-20">
            ...
            <p
              ...
              className="text-xs md:text-sm mb-4 md:mb-6 text-gray-200"
            >
          ...
          <div
            data-aos="fade-left"
            className="md:flex flex-col gap-4  absolute right-4 md:right-6 bottom-6 z-20"
          >
